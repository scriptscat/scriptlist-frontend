...
import { setThemeCookie, ThemeMode } from '@/lib/cookies';
...
export const ThemeClientProvider: React.FC<ThemeClientProviderProps> = ({
  ...
  const antdTheme: ThemeConfig = {
    ...
    token: {
      ...
      boxShadowSecondary: themeMode.theme === 'dark'
    ...
    components: {
      ...
      Button: {
        ...
        primaryShadow: themeMode.theme === 'dark' 
      ...
      // 卡片组件 - GitHub风格卡片
      Card: {
        colorBorderSecondary: themeMode.theme === 'dark' ? '#30363d' : '#d0d7de',
        colorBgContainer: themeMode.theme === 'dark' ? '#161b22' : '#ffffff',
      },
      ...
      Menu: {
        ...
        colorItemTextSelected: themeMode.theme === 'dark' ? '#58a6ff' : '#0969da',
      },
      ...
      Modal: {
        colorBgElevated: themeMode.theme === 'dark' ? '#161b22' : '#ffffff',
        colorBgMask: themeMode.theme === 'dark' 
          ? 'rgba(13, 17, 23, 0.6)' 
          : 'rgba(0, 0, 0, 0.45)',
      },
