 ...
 * 脚本关注功能Hook
 */
export function useScriptWatch(scriptId: number, initialWatchLevel: WatchLevel = WatchLevel.NONE) {
  ...
  const toggleWatch = async () => {
    const newLevel = watchLevel === WatchLevel.NONE ? WatchLevel.VERSION : WatchLevel.NONE;
